...
#code1 = "code1"
#code2 = "code4"
allCode = ["code1","code1cp", "code2","code3","code4", "code5"]
...
for i in range(len(allCode)-1):
    for j in range(i+1, len(allCode)):
        ...
        if GM.is_isomorphic():
            print("The two graphs from "+code1 + " and " + code2 +" are isomophic.")
            print("The structures of "+ code1 + " and " + code2 + " seem to be identical.  Please investigate further.")
        else:
            print("The two graphs from "+code1 + " and " + code2 +" are not isomophic.")
            print("The structures of "+code1 + " and " + code2 +" do not seem to be identical.")
        
        print()
        if gammaIsomorphic(G1, G2, gamma):
            print("A subgraph of "+code2+" with a gamma of "+ str(gamma) +" is subgraphisomophic to "+code1+".")
            print(code1+ " and " + code2 +" seem to violate the threshold for similiarity.  Please investigate further.")
            isoCount += 1
        else:
            print("There is no subgraph of "+code2+" with a gamma of "+ str(gamma) +" that is subgraph isomophic to "+code1+".")
